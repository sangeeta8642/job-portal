...
export const updateJob = async (req, res) => {
    try {
        ...
        const userId = req.id; // Assuming this is the ID of the logged-in user
        // const companyId = req.params.id
        // console.log(title, description, requirements, salary, location, jobType, experienceLevel, position,company);
